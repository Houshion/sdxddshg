...
class GoodsType extends Model
{
     ...
     */
    public function get_list($condition=null,$field='*',$page=1,$psize=10,$order=null)
    {
        $res = $this->where($condition)->field($field)->order($order)->page($page,$psize)->select();
        return $res;
    }
     ...
     * @throws \think\exception\DbException
     */
    public function get_join_list($table=array(),$where_join=null,$condition=null,$page=1,$psize=10,$field='*',$order=null,$group=null)
    {
        $res = $this->table($table)->where($where_join)->where($condition)->field($field)->order($order)->group($group)->page($page,$psize)->select();
        return $res;
    }
     ...
     * @throws \think\exception\DbException
     */
    public function get_row_join($table=array(),$where_join=null,$condition=null,$field='*')
    {
        $res = $this->table($table)->where($where_join)->where($condition)->field($field)->find();
        return $res;
    }
