;(function () {
    ...
    $('.check').on('click',function (){
        ...
        var mb = '<textarea class="form-control" id="reason" name="reason" rows="5" maxlength="100" placeholder="请输入审核原因" data-bv-notempty="true" data-bv-notempty-message="不能为空"></textarea>';
        bootbox.dialog({
            message: mb,
            title: "审核原因",
            ...
            buttons: {
                "确定":{
                    ...
                    callback:function () {
                        ...
                        var data = 'reason='+reason+'&&id='+id+'&&status='+status+'&&type='+type;
                        console.log(data);
                        // var tourl = "{:url('admin/Supply/order_sh')}";
                        var callok = function() {
                            //成功后刷新
